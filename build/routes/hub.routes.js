...
router.put('/update/patient/:patient_id', _middlewares.authJwt.verifyToken, patientCtrl.update_patient);
...
router.get('/get/all/patients/:userId', _middlewares.authJwt.verifyToken, patientCtrl.get_all_patients);
