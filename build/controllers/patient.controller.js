...
module.exports.create_patient = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _yield$req$body, name, last_name, age, gender, image, phone, email, newPatient, errors;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            last_name = _yield$req$body2.last_name;
            age = _yield$req$body2.age;
            gender = _yield$req$body2.gender;
