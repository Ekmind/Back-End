...
exports.verifyToken = exports.requireAuth = exports.isModerator = exports.isAdmin = exports.checkUser = void 0;
...
var requireAuth = function requireAuth(res, req, next) {
  ...
  try {
    if (token) {
      _jsonwebtoken["default"].verify(token, process.env.JWT_SECRET, /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(err, decodedToken) {
          var user;
